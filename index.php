...
<body>
            ...
            <div class="container-fluid">
                <div class="navbar-brand">
                    <span class="navbar-logo">
                        <a href="index.php">
                            <img src="Aarogyni.png" alt="Mobirise" style="height: 5rem;">
                        </a>
                    </span>
                </div>
            ...
            <div class="row justify-content-end">
                <div class="col-12 col-lg-5">
                    <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1">
                        <strong style="font-family: 'Dancing Script', cursive;">Arogyni</strong>
                    </h1>
                    <p class="mbr-text mbr-fonts-style display-7">
                        Our one-stop solution for your protection.
                    </p>
                    <div class="mbr-section-btn mt-3">
                        <a class="btn btn-white display-4" href="#image1-m">
                            <out style="color:darkorchid;">Find out more</strong></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-5">
                    <div class="image-wrapper">
                        <img src="groupofwomens.png" alt="We're in this together">
                ...
                <div class="col-12 col-lg">
                    <div class="text-wrapper">
                        <h3 class="mbr-section-title mbr-fonts-style mb-3 display-5">
                            <strong style="font-family: 'Dancing Script', cursive,; color: purple; ">About Us</strong>
                        </h3>
                        <p class="mbr-text mbr-fonts-style display-7">
    ...
    <section class="info3 cid-smHa3xqxC6 mbr-parallax-background" id="info3-r">
        <div class="mbr-overlay" style="opacity: 0.6; background-color: rgba(255,177,138);">
        </div>
        <div class="container">
            <div class="row justify-content-center">
        ...
        <div class="container">
            <div class="mbr-section-head">
                <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                    <strong style="font-family: 'Dancing Script', cursive; color:purple;">Other Features</strong>
                </h4>
        ...
        <div class="container">
            <div class="media-container-row align-center mbr-white">
                ...
                <div class="row row-copirayt">
                    <p class="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7">Made by Team Ignite&nbsp;</p>
                </div>
            </div>
        </div>
    </section>
