...
if (isset($_POST['doctor'])) {
    ...
    $sql = "INSERT INTO `feminine`.`users` (`userid`, `username`, `password`, `email`, `occupation`, `hospital_name`) VALUES ('$uid', '$u_name', '$securepass', '$email', '$occupation', '$hospital_name')";
            ...
            <div class="container-fluid">
                <div class="navbar-brand">
                    <span class="navbar-logo">
                        <a href="index.php">
                            <img src="Aarogyni.png" alt="logo" style="height: 5rem;">
                        </a>
                    </span>
                </div>
                ...
                <div class="text-wrapper align-items-right">
                    ...
                    <div>
                        <form method="post" id="signupForm">
                            ...
                            <div class="form-floating form-field-login">
                                <label for="hospital">Hospital Name(For Doctors only)</label>
                                <input type="text" class="form-control" id="hospital" placeholder="Hospital Name" name="hospital_name">
                            </div>
