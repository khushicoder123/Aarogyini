        ...
        <div class="container-fluid">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="index.php">
                        <img src="Aarogyni.png" alt="login" style="height: 5rem;">
                    </a>
                </span>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <div class="dashboard-main-card">
                    ...
                    <div id="doctor-details">
                        <?php
                        $query="SELECT prescription.title,prescription.prescription,users.username,users.hospital_name
                        FROM prescription
                        JOIN users ON prescription.doctorId=users.userid
                        WHERE prescription.patientId='$pid'";
                    $res = $con->query($query);
                    if($res){
                        while($row=$res->fetch_array()){
                            ...
                            <div class='doctor-details'>
                                    <div style='display:flex'>
                                        <div style=''color:#ff6666;font-weight:500;margin-right:10px'>Doctor:</div>
                                        <div>$doctorName</div>
                                    </div>
                                    <div style='display:flex'>
                                        <div style=''color:#ff6666;font-weight:500;margin-right:10px'>Hospital:</div>
